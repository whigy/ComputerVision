...
% Change the scale for histogram
pixels_hist = pixels/max(max(pixels));
pixels2_hist = pixels2/max(max(pixels2));
...
subplot(1,2,1)
imhist(pixels_hist)
title('Grad magn of original im')

subplot(1,2,2)
imhist(pixels2_hist)
title('Grad magn of smoothed im')